...
3. `setup-plan` binds public workspace metadata, inspection, and the reviewed AI
   tracking plan into typed install/create/manual/check operations. It accepts an
