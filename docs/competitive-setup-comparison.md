...
| Capability                               | Usermaven Wizard 0.6                                          | Amplitude Wizard                                                                                      | PostHog Wizard / MCP                                                           |
| ---------------------------------------- | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
...
| Propose a tracking plan                  | Deterministic baseline; custom/revenue review remains         | AI proposes events from the codebase                                                                  | AI wizard and program-specific audits                                          |
...
| Source privacy default                   | Source stays local                                            | AI analyzes the local codebase; public docs do not promise the same deterministic local-only boundary | Wizard sends selected source to Anthropic through PostHog's gateway by default |
...
6. An explicit reviewed workflow for custom business and revenue events.
